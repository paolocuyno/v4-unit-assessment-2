...
//     for(j=0;j<lettersToPair.length,j++)
// }
...
//CODE HERE
  let phone1 = new Phone('Nokia','phone',64,'red',false)
  
  let phone2 =new Phone('Sony','a7',256,'grey',false)
  
  let phone3 = new Phone('Samsung','Galaxy',528,'blue',false)
